      ...
      "subcategories": [
        {
          "id": "ecoflow",
          "name": "EcoFlow",
          "description": "Descubre los innovadores generadores solares y estaciones de energía de EcoFlow."
        },
        {
          "id": "champion",
          "name": "Champion",
          "description": "Análisis de los potentes y fiables generadores de combustible Champion."
        },
        {
          "id": "bluetti",
          "name": "Bluetti",
          "description": "Explora las soluciones de energía portátil y solar de Bluetti."
        },
        {
          "id": "honda",
          "name": "Honda",
          "description": "Generadores Honda: sinónimo de durabilidad, rendimiento y confianza."
        },
        {
          "id": "hyundai",
          "name": "Hyundai",
          "description": "Soluciones de energía Hyundai para uso industrial y doméstico."
        },
        {
          "id": "pulsar",
          "name": "Pulsar",
          "description": "Generadores Pulsar: potencia accesible para todos tus proyectos."
        },
        {
          "id": "einhell",
          "name": "Einhell",
          "description": "Herramientas y generadores Einhell para el hogar y el taller."
        }
      ]
    }
  ]
